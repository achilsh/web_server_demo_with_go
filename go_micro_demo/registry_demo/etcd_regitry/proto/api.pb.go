...
func (x *PNReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PNReq) ProtoMessage() {}

func (x *PNReq) ProtoReflect() protoreflect.Message {
	mi := &file_proto_api_proto_msgTypes[0]
...
// Deprecated: Use PNReq.ProtoReflect.Descriptor instead.
func (*PNReq) Descriptor() ([]byte, []int) {
	return file_proto_api_proto_rawDescGZIP(), []int{0}
}

func (x *PNReq) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *PNRsp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PNRsp) ProtoMessage() {}

func (x *PNRsp) ProtoReflect() protoreflect.Message {
	mi := &file_proto_api_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PNRsp.ProtoReflect.Descriptor instead.
func (*PNRsp) Descriptor() ([]byte, []int) {
	return file_proto_api_proto_rawDescGZIP(), []int{1}
}

func (x *PNRsp) GetMsg() string {
	if x != nil {
		return x.Msg
	}
	return ""
...
var file_proto_api_proto_rawDesc = []byte{
	...
	,
...
var file_proto_api_proto_goTypes = []interface{}{
	(*PNReq)(nil), // 0: backend.PNReq
	(*PNRsp)(nil), // 1: backend.PNRsp
}
var file_proto_api_proto_depIdxs = []int32{
	0, // 0: backend.Api.PName:input_type -> backend.PNReq
	1, // 1: backend.Api.PName:output_type -> backend.PNRsp
