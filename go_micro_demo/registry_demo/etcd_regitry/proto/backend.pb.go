...
func (x *BkReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BkReq) ProtoMessage() {}

func (x *BkReq) ProtoReflect() protoreflect.Message {
	mi := &file_proto_backend_proto_msgTypes[0]
...
// Deprecated: Use BkReq.ProtoReflect.Descriptor instead.
func (*BkReq) Descriptor() ([]byte, []int) {
	return file_proto_backend_proto_rawDescGZIP(), []int{0}
}

func (x *BkReq) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *BkResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BkResp) ProtoMessage() {}

func (x *BkResp) ProtoReflect() protoreflect.Message {
	mi := &file_proto_backend_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BkResp.ProtoReflect.Descriptor instead.
func (*BkResp) Descriptor() ([]byte, []int) {
	return file_proto_backend_proto_rawDescGZIP(), []int{1}
}

func (x *BkResp) GetMsg() string {
	if x != nil {
		return x.Msg
	}
	return ""
...
var file_proto_backend_proto_rawDesc = []byte{
	...
	,
...
var file_proto_backend_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_proto_backend_proto_goTypes = []interface{}{
	(*BkReq)(nil),  // 0: backend.BkReq
	(*BkResp)(nil), // 1: backend.BkResp
}
var file_proto_backend_proto_depIdxs = []int32{
	0, // 0: backend.Backend.RetName:input_type -> backend.BkReq
	1, // 1: backend.Backend.RetName:output_type -> backend.BkResp
